...
$sql_query = "SELECT * FROM loan WHERE imId='$mId'";
...
<div class="full">
    ...
    <p style="margin-top:5%;margin-left:20%;margin-bottom:3%;font-size:2em;color:#577590"><strong>投資資訊</strong></p>
            ...
            <?php while ($row = mysqli_fetch_assoc($result)) {
                ...
                if ($row['mId'] != $_COOKIE['mId']) { ?>
                    <tr>
                        ...
                        <td class="data"><?php if ($row['progress'] == 0) { ?>
                                <a href=gotopay.php?lId=<?php echo $row['lId'] ?>><button>付款去</button></a></td><?php } else {
                                                                                                                echo ('已付款');
                                                                                                            } ?>
                    </tr>
            <?php }
