...
$sql_query = "SELECT * FROM loan WHERE lId='$lId'";
...
<body>
	<div class="full">
		...
		<p style="margin-top:5%;margin-left:10%;margin-bottom:3%;font-size:2em;color:#577590"><strong>我要投資該筆資料</strong></p>
		<div class="content" align='center'>
			...
			<a href=wannainvest.php><button class="wi">上一頁</button></a>&nbsp;&nbsp;<a href=invest.php?lId=<?php echo $lId ?>><button class="wi">確認</button></a>
		</div>
