                ...
                <form action="resetpw1.php" method="post">
                    <div class="loginBox">
                        <div class="loginBoxCenter">
                            ...
                            <p>原密碼：</p>
                            <p><input type="password" id="opassword" name="opassword" class="loginInput" required="required" placeholder="請輸入舊密碼" value="" /></p>
                            <p>新密碼：</p>
                            <p><input type="password" id="npassword" name="npassword" class="loginInput" required="required" placeholder="請輸入新密碼" value="" /></p>
                            <!-- required 規定必需在提交之前填寫輸入欄位-->
                            <p>重新輸入新密碼：</p>
                            <p><input type="password" id="rnpassword" name="rnpassword" class="loginInput" required="required" placeholder="請再輸入新密碼" value="" /></p>
                            <!-- <p>頭像：</p>
                    <p>
                      <input type="file" name="photo"/>                        
                        ...
                        <div class="loginBoxButtons">
                            ...
                            <button class="loginBtn">修改密碼</button>
                        </div>
